...
describe("buildStages", () => {
  ...
  // 350面以降のspecial/chainミッションが最低値2に張り付いたまま
  // 152面分ほとんど伸びなかった問題の再発防止（2026-07-24修正）。
  // count=4まで上げるとhole配置次第でクリア率が5%を割るステージが
  // 一定確率で発生することをシミュレーションで確認したため、
  // 350面直後の最低値(旧: 2)から3へ引き上げた上で、
