 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oe=new Ji("@firebase/app"),Aa="@firebase/app-compat",Da="@firebase/analytics-compat",Pa="@firebase/analytics",Oa="@firebase/app-check-compat",Ma="@firebase/app-check",xa="@firebase/auth",La="@firebase/auth-compat",Fa="@firebase/database",$a="@firebase/data-connect",Ba="@firebase/database-compat",Wa="@firebase/functions",Ha="@firebase/functions-compat",Ua="@firebase/installations",ja="@firebase/installations-compat",Va="@firebase/messaging",qa="@firebase/messaging-compat",Ga="@firebase/performance",za="@firebase/performance-compat",Ya="@firebase/remote-config",Ka="@firebase/remote-config-compat",Qa="@firebase/storage",Xa="@firebase/storage-compat",Ja="@firebase/firestore",Za="@firebase/ai",el="@firebase/firestore-compat",tl="firebase",nl="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new wl(e)}}catch{}return new El},Ee=rr("localStorage"),Il=rr("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const t of e.values())this.sendListen_(t);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let t="js";e["sdk."+t+"."+ir.replace(/\./g,"-")]=1,Ki()?e["framework.cordova"]=1:Xo()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=Ut.getInstance().currentlyOnline();return Fn(this.interruptReasons_)&&e}}re.nextPersistentConnectionId_=0;re.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Dt;class Ar extends on{static get __EMPTY_NODE(){return Dt}static set __EMPTY_NODE(e){Dt=e}compare(e,t){return ke(e.name,t.name)}isDefinedOn(e){throw Ye("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return C.MIN}maxPost(){return new C(Se,Dt)}makePost(e,t){return f(typeof e=="string","KeyIndex indexValue must always be a string."),new C(e,Dt)}toString(){return".key"}}const Be=new Ar;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yc(n,e){return ke(n.name,e.name)}function _s(n,e){return ke(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Or,Mr;function Cc(n){Or=n}function wc(n){Mr=n}class Ec extends on{compare(e,t){const s=e.node.getPriority(),i=t.node.getPriority(),r=s.compareTo(i);return r===0?ke(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return C.MIN}maxPost(){return new C(Se,new F("[PRIORITY-POST]",Mr))}makePost(e,t){const s=Or(e);return new C(t,new F("[PRIORITY-POST]",s))}toString(){return".priority"}}const D=new Ec;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let kn;const Oe={};class ie{static get Default(){return f(Oe&&D,"ChildrenNode.ts has not been loaded"),kn=kn||new ie({".priority":Oe},{".priority":D}),kn}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=Ie(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof j?t:null}hasIndex(e){return Z(this.indexSet_,e.toString())}addIndex(e,t){f(e!==Be,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator(C.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=jt(s,e.getCompare()):a=Oe;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new ie(d,c)}addToIndexes(e,t){const s=Ft(this.indexes_,(i,r)=>{const o=Ie(this.indexSet_,r);if(f(o,"Missing index implementation for "+r),i===Oe)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(C.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),jt(a,o.getCompare())}else return Oe;else{const a=t.get(e.name);let l=i;return a&&(l=l.remove(new C(e.name,a))),l.insert(e,e.node)}});return new ie(s,this.indexSet_)}removeFromIndexes(e,t){const s=Ft(this.indexes_,i=>{if(i===Oe)return i;{const r=t.get(e.name);return r?i.remove(new C(e.name,r)):i}});return new ie(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kc extends on{compare(e,t){const s=e.node.compareTo(t.node);return s===0?ke(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return C.MIN}maxPost(){return C.MAX}makePost(e,t){const s=M(e);return new C(t,s)}toString(){return".value"}}const Ac=new kc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Te{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=X.OVERWRITE}operationForChild(e){return b(this.path)?new Te(this.source,E(),this.snap.getImmediateChild(e)):new Te(this.source,N(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=X.MERGE}operationForChild(e){if(b(this.path)){const t=this.children.subtree(new S(e));return t.isEmpty()?null:t.value?new Te(this.source,E(),t.value):new Ve(this.source,E(),t)}else return f(y(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ve(this.source,N(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ou{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const Ur=new ou;class Es{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new _e(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ws(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Re(this.viewCache_),r=iu(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Th="FIREBASE_DATABASE_EMULATOR_HOST",ss={};let Rh=!1;function Nh(n,e,t,s){const i=e.lastIndexOf(":"),r=e.substring(0,i),o=os(r);n.repoInfo_=new yr(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),s&&(n.authTokenProvider_=s)}function kh(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||ae("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),B("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Li(r,i),a=o.repoInfo,l;typeof process<"u"&&si&&(l=si[Th]),l?(r=`http://${l}?ns=${a.namespace}`,o=Li(r,i),a=o.repoInfo):o.repoInfo.secure;const c=new Fl(n.name,n.options,e);Xu("Invalid Firebase Database URL",o),b(o.path)||ae("Database URL must point to the root of a Firebase Database (not including a child path).");const d=Dh(a,n,c,new Ll(n,t));return new Ph(d,n)}function Ah(n,e){const t=ss[e];(!t||t[n.key]!==n)&&ae(`Database ${e}(${n.repoInfo_}) has already been deleted.`),_h(n),delete t[n.key]}function Dh(n,e,t,s){let i=ss[e.name];i||(i={},ss[e.name]=i);let r=i[n.toURLString()];return r&&ae("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new nh(n,Rh,t,s),i[n.toURLString()]=r,r}class Ph{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(sh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new ee(this._repo,E())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Ah(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&ae("Cannot call "+e+" on a deleted database.")}}function Oh(n=ul(),e){const t=rl(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=Vo("database");s&&Mh(t,...s)}return t}function Mh(n,e,t,s={}){n=ve(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&$t(s,r.repoInfo_.emulatorOptions))return;ae("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)s.mockUserToken&&ae('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Mt(Mt.OWNER);else if(s.mockUserToken){const a=typeof s.mockUserToken=="string"?s.mockUserToken:Go(s.mockUserToken,n.app.options.projectId);o=new Mt(a)}os(e)&&(qo(e),Ko("Database",!0)),Nh(r,i,s,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */Fe(Fh,$h,"app");const Bh={apiKey:"AIzaSyBUWOun6Fc6R58T_FAxDB217kypYi_Y59c",authDomain:"mori-no-yakai.firebaseapp.com",databaseURL:"https://mori-no-yakai-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"mori-no-yakai",storageBucket:"mori-no-yakai.firebasestorage.app",messagingSenderId:"126231981141",appId:"1:126231981141:web:b593b219aeec9f8a7078dc",measurementId:"G-TK8226P7P9"},Wh=tr(Bh),R=Oh(Wh),Hh="1night",po="mori-no-yakai-host-unlocked";function Uh(n){return n.trim()===Hh}function _o(){return localStorage.getItem(po)==="1"}function jh(){localStorage.setItem(po,"1")}const v={villager:{id:"villager",name:"うさぎ",emoji:"🐰",team:"forest",description:"夜は何もせず眠っています。"},werewolf:{id:"werewolf",name:"おおかみ",emoji:"🐺",team:"wolf",description:"夜、仲間のおおかみと顔を見合わせます。1匹だけなら中央カードを1枚見られます。"},seer:{id:"seer",name:"ふくろう",emoji:"🦉",team:"forest",description:"夜、他の1人のカード、または中央カード2枚のどちらかを見られます。"},robber:{id:"robber",name:"きつね",emoji:"🦊",team:"forest",description:"夜、他の1人と自分のカードを交換し、新しい役職を確認します。"},minion:{id:"minion",name:"子狼",emoji:"🐾",team:"wolf",description:"夜、おおかみが誰かを確認します（自分の正体はおおかみ側には明かされません）。"}},Vh=["werewolf","minion","seer","robber"];function mo(n){return{centerCount:3,werewolfCount:n<=5?1:2,seer:!0,robber:!0,minion:!0}}function Hs(n,e){const t=e.werewolfCount+(e.seer?1:0)+(e.robber?1:0)+(e.minion?1:0);return n+e.centerCount-t}function $i(n,e){return e.werewolfCount<0?!1:Hs(n,e)>=0}function qh(n,e){const t=Hs(n,e);if(t<0)throw new Error("役職構成が不正です（うさぎの数がマイナスになります）");const s=[];for(let i=0;i<e.werewolfCount;i++)s.push("werewolf");e.seer&&s.push("seer"),e.robber&&s.push("robber"),e.minion&&s.push("minion");for(let i=0;i<t;i++)s.push("villager");return s}function Gh(n){const e=new Set;return n.werewolfCount>0&&e.add("werewolf"),n.minion&&e.add("minion"),n.seer&&e.add("seer"),n.robber&&e.add("robber"),Vh.filter(t=>e.has(t))}function zh(n,e=Math.random){const t=n.slice();for(let s=t.length-1;s>0;s--){const i=Math.floor(e()*(s+1));[t[s],t[i]]=[t[i],t[s]]}return t}const Yh=[15e3,3e4,45e3,6e4],At=3e4,go=1e4,Kh=6e4,Qh=[3*6e4,5*6e4,8*6e4],Xh=5*6e4;function Jh(n){const e={};for(const i of n)e[i.id]=0;for(const i of n)i.vote&&i.vote in e&&(e[i.vote]+=1);const t=Math.max(0,...Object.values(e)),s=t>=2?Object.entries(e).filter(([,i])=>i===t).map(([i])=>i):[];return{counts:e,eliminatedIds:s}}function Zh(n,e){const t=new Set(e);return n.some(r=>t.has(r.id)&&r.currentRole==="werewolf")||!n.some(r=>r.currentRole==="werewolf")&&(e.length===0||n.some(o=>t.has(o.id)&&o.currentRole==="minion"))?"forest":"wolf"}function ed(n,e){return n.length===0?!1:n.every(t=>(t.nightReadyStep??-1)>=e)}function Bi(n,e){const t=n.nightStepDurationMs??At,s=n.nightStepEndsAt-t;return e-s>=go}function vo(n,e){const t=n.nightStepDurationMs??At,s=n.nightStepIndex+1;return s>=n.nightOrder.length?{...n,phase:"discuss",discussEndsAt:e+n.discussDurationMs}:{...n,nightStepIndex:s,nightStepEndsAt:e+t}}function yo(n,e){return{...n,phase:"vote",voteEndsAt:e+Kh}}function td(n,e){return n.length===0?!1:n.every(t=>t.discussReadyRound===e)}function bo(n){return{...n,phase:"result"}}function nd(n){return Object.keys(n).filter(e=>!n[e].left)}const Wi="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";function sd(){let n="";for(let e=0;e<5;e++)n+=Wi[Math.floor(Math.random()*Wi.length)];return n}function id(){return crypto.randomUUID()}async function Co(n,e,t){const s=T(R,`rooms/${n}/members/${e}`),i=T(R,`rooms/${n}/state`);if(!(await Ne(i)).exists()){if(!_o())throw new Error("この部屋は存在しません");const a={phase:"lobby",hostId:e,createdAt:Date.now(),roleConfig:mo(1),nightOrder:[],nightStepIndex:0,nightStepDurationMs:At,nightStepEndsAt:0,discussDurationMs:Xh,discussEndsAt:0,voteEndsAt:0,roundNumber:0};await Fi(i,a)}if((await Ne(s)).exists())await Pe(s,{name:t,online:!0,left:!1});else{const a={id:e,name:t,online:!0,joinedAt:Date.now()};await Fi(s,a)}fo(T(R,`rooms/${n}/members/${e}/online`)).set(!1)}async function rd(n,e){await Pe(T(R,`rooms/${n}/members/${e}`),{online:!0}),fo(T(R,`rooms/${n}/members/${e}/online`)).set(!1)}async function od(n,e){await Pe(T(R,`rooms/${n}/members/${e}`),{online:!1,left:!0})}function ad(n,e){return yn(T(R,`rooms/${n}/state`),t=>e(t.val()))}function ld(n,e){return yn(T(R,`rooms/${n}/members`),t=>e(t.val()??{}))}function cd(n,e){return yn(T(R,`rooms/${n}/centerCards`),t=>{const s=t.val();if(Array.isArray(s)){e({round:-1,cards:s});return}e(s)})}async function ud(n,e){await Pe(T(R,`rooms/${n}/state`),{roleConfig:e})}async function hd(n,e){await Pe(T(R,`rooms/${n}/state`),{discussDurationMs:e})}function dd(n){return mo(n)}async function fd(n){await te(T(R,`rooms/${n}`),e=>{if(!e||!e.state||e.state.phase!=="lobby")return e;const t=e.members??{},s=nd(t);if(s.length<3)return e;const i=qh(s.length,e.state.roleConfig),r=zh(i),o=r.slice(0,s.length),a=r.slice(s.length);for(const u of Object.keys(t))delete t[u].originalRole,delete t[u].currentRole,delete t[u].knownRole,delete t[u].vote,delete t[u].nightReadyStep,delete t[u].discussReadyRound,delete t[u].seerReveal;s.forEach((u,h)=>{t[u].originalRole=o[h],t[u].currentRole=o[h],t[u].knownRole=o[h]});const l=Gh(e.state.roleConfig),c=e.state.nightStepDurationMs??At,d=(e.state.roundNumber??0)+1;return e.members=t,e.centerCards={round:d,cards:a},e.state={...e.state,phase:l.length>0?"night":"discuss",nightOrder:l,nightStepIndex:0,nightStepDurationMs:c,nightStepEndsAt:Date.now()+c,discussEndsAt:Date.now()+e.state.discussDurationMs,roundNumber:d},e})}async function pd(n,e){await Pe(T(R,`rooms/${n}/state`),{nightStepDurationMs:e})}async function _d(n,e,t){const s=T(R,`rooms/${n}/members/${e}/currentRole`),i=T(R,`rooms/${n}/members/${t}/currentRole`),[r,o]=await Promise.all([Ne(s),Ne(i)]),a=r.val(),l=o.val();return await Pe(T(R,`rooms/${n}/members`),{[`${e}/currentRole`]:l,[`${t}/currentRole`]:a,[`${e}/knownRole`]:l}),l}async function On(n,e,t,s){await te(T(R,`rooms/${n}`),i=>{var r;return!(i!=null&&i.state)||i.state.phase!=="night"||i.state.roundNumber!==t||!((r=i.members)!=null&&r[e])||(i.members[e].seerReveal=s),i})}async function md(n,e,t){await te(T(R,`rooms/${n}`),s=>{var i;return!s||!s.state||s.state.phase!=="vote"||!((i=s.members)!=null&&i[e])||(s.members[e].vote=t),s})}async function wo(n){await te(T(R,`rooms/${n}`),e=>{if(!e||!e.state)return e;const t=e.state,s=Date.now();return t.phase==="night"&&s>=t.nightStepEndsAt?e.state=vo(t,s):t.phase==="discuss"&&s>=t.discussEndsAt?e.state=yo(t,s):t.phase==="vote"&&s>=t.voteEndsAt&&(e.state=bo(t)),e})}async function gd(n,e,t){await te(T(R,`rooms/${n}`),s=>{var i;return!(s!=null&&s.state)||s.state.phase!=="night"||s.state.nightStepIndex!==t||!((i=s.members)!=null&&i[e])||(s.members[e].nightReadyStep=t),s}),await Ct(n)}let be=null;function vd(n,e){const t=`${n}:${e.nightStepIndex}`;if((be==null?void 0:be.key)===t)return;be&&clearTimeout(be.timer);const s=e.nightStepDurationMs??At,i=e.nightStepEndsAt-s,r=Math.max(0,go-(Date.now()-i)),o=setTimeout(()=>{be=null,Ct(n)},r+50);be={key:t,timer:o}}async function Ct(n){const t=(await Ne(T(R,`rooms/${n}`))).val();if(!(t!=null&&t.state)||t.state.phase!=="night")return;const s=t.members??{},i=Object.values(s).filter(r=>r.originalRole);if(ed(i,t.state.nightStepIndex)){if(!Bi(t.state,Date.now())){vd(n,t.state);return}await te(T(R,`rooms/${n}`),r=>(!(r!=null&&r.state)||r.state.phase!=="night"||r.state.nightStepIndex!==t.state.nightStepIndex||!Bi(r.state,Date.now())||(r.state=vo(r.state,Date.now())),r))}}async function yd(n,e,t){await te(T(R,`rooms/${n}`),s=>{var i;return!(s!=null&&s.state)||s.state.phase!=="discuss"||s.state.roundNumber!==t||!((i=s.members)!=null&&i[e])||(s.members[e].discussReadyRound=t),s}),await Us(n)}async function Us(n){const t=(await Ne(T(R,`rooms/${n}`))).val();if(!(t!=null&&t.state)||t.state.phase!=="discuss")return;const s=t.members??{},i=Object.values(s).filter(r=>r.originalRole);td(i,t.state.roundNumber)&&await te(T(R,`rooms/${n}`),r=>(!(r!=null&&r.state)||r.state.phase!=="discuss"||r.state.roundNumber!==t.state.roundNumber||(r.state=yo(r.state,Date.now())),r))}async function js(n){const t=(await Ne(T(R,`rooms/${n}/members`))).val()??{},s=Object.values(t).filter(i=>i.originalRole);s.length===0||!s.every(i=>i.vote)||await te(T(R,`rooms/${n}`),i=>(!(i!=null&&i.state)||i.state.phase!=="vote"||(i.state=bo(i.state)),i))}async function Eo(n){await te(T(R,`rooms/${n}`),e=>{if(!e||!e.state)return e;const t=e.members??{};for(const s of Object.keys(t))delete t[s].originalRole,delete t[s].currentRole,delete t[s].knownRole,delete t[s].vote,delete t[s].nightReadyStep,delete t[s].discussReadyRound,delete t[s].seerReveal;return e.members=t,e.centerCards=null,e.state={...e.state,phase:"lobby",nightOrder:[],nightStepIndex:0,nightStepEndsAt:0,voteEndsAt:0},e})}function Io(n){return n.state.hostId}function Vs(n){return Io(n)===n.memberId}function bd(n){return Object.values(n.members).filter(e=>!e.left)}function le(n){return Object.values(n.members).filter(e=>e.originalRole)}function Cd(n){var e;return So((e=n.members[n.memberId])==null?void 0:e.currentRole)}function qs(n){const e=n.members[n.memberId];return So((e==null?void 0:e.knownRole)??(e==null?void 0:e.originalRole))}function So(n){if(!n)return"";const e=v[n];return`<p class="role-reminder">${e.emoji} あなたは ${e.name}</p>`}function bn(n){var t,s;const e=(t=n.members[n.memberId])==null?void 0:t.seerReveal;if(!e||e.kind==="skip")return"";if(e.kind==="player"&&((s=e.roles)!=null&&s[0])){const i=v[e.roles[0]];return`<p class="hint-text seer-memo">🦉 見たもの: ${wd(e.targetName??"?")}は ${i.emoji} ${i.name}</p>`}return e.kind==="center"&&e.roles&&e.roles.length>0?`<p class="hint-text seer-memo">🦉 見たもの: 中央カードは ${e.roles.map(r=>`${v[r].emoji} ${v[r].name}`).join(" と ")}</p>`:""}function wd(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}function Ed(n,e){var c,d;const t=Vs(e),s=bd(e),i=e.state.roleConfig,r=e.state.discussDurationMs,o=e.state.nightStepDurationMs,a=Hs(s.length,i),l=$i(s.length,i)&&s.length>=3;n.innerHTML=`
  ...
  `,h=a?l?Nd(i,e):kd(i,e):`
    ...
    ${en(e)}
  `,a&&!l&&Ad(n,i,e),(w=n.querySelector("#btn-night-ready"))==null||w.addEventListener("click",()=>{g.readyTapped||g.robberPending||(g.readyTapped=!0,se(n,e),gd(e.roomId,e.memberId,t))}),(P=n.querySelector("#btn-leave-room"))==null||P.addEventListener("click",()=>{e.requestLeaveRoom()}),tn(n,e)}function Nd(n,e){var t;switch(n){case"werewolf":return le(e).filter(i=>i.originalRole==="werewolf").length>=2||g.wolfPeekIndex!==void 0?To(e):`<p>${v.werewolf.emoji} 中央カードは見ませんでした。</p>`;case"minion":return Ro(e);case"seer":return g.seerChoice||(t=e.members[e.memberId])!=null&&t.seerReveal?No(e):`<p>${v.seer.emoji} 何も見ませんでした。</p>`;case"robber":return g.robberResult?ko(e):`<p>${v.robber.emoji} 誰とも交換しませんでした。</p>`;case"villager":return"<p>あなたはうさぎ。することはありません。</p>"}}function kd(n,e){switch(n){case"werewolf":return To(e);case"minion":return Ro(e);case"seer":return No(e);case"robber":return ko(e);case"villager":return`
  ...
  `}function ko(n){const e=`<p class="role-description">${v.robber.description}</p>`;if(g.robberResult)return`<p>${v.robber.emoji} 交換後、あなたの役職は ${v[g.robberResult].emoji} ${v[g.robberResult].name}</p>${e}`;if(g.robberPending)return`<p>${v.robber.emoji} 交換中…</p>${e}`;const t=le(n).filter(s=>s.id!==n.memberId);return`
    ...
    ${e}
  `}function Ad(n,e,t){var s,i,r;e==="werewolf"&&n.querySelectorAll("[data-center-peek]").forEach(o=>{o.addEventListener("click",()=>{g.wolfPeekIndex===void 0&&(g.wolfPeekIndex=Number(o.dataset.centerPeek),se(n,t))})}),e==="seer"&&(n.querySelectorAll("[data-seer-player]").forEach(o=>{o.addEventListener("click",()=>{if(g.seerChoice)return;const a=o.dataset.seerPlayer;g.seerChoice="player",g.seerTargetId=a,se(n,t);const l=t.members[a];On(t.roomId,t.memberId,t.state.roundNumber,{kind:"player",targetId:a,targetName:l.name,roles:l.currentRole?[l.currentRole]:void 0})})}),(s=n.querySelector("[data-seer-center]"))==null||s.addEventListener("click",()=>{if(g.seerChoice)return;g.seerChoice="center",se(n,t);const o=g.centerCardsSnapshot??t.centerCards;On(t.roomId,t.memberId,t.state.roundNumber,{kind:"center",roles:o.slice(0,2)})}),(i=n.querySelector("[data-seer-skip]"))==null||i.addEventListener("click",()=>{g.seerChoice||(g.seerChoice="skip",se(n,t),On(t.roomId,t.memberId,t.state.roundNumber,{kind:"skip"}))})),e==="robber"&&(n.querySelectorAll("[data-robber-target]").forEach(o=>{o.addEventListener("click",()=>{if(g.robberPending||g.robberResult)return;g.robberPending=!0;const a=o.dataset.robberTarget;se(n,t),_d(t.roomId,t.memberId,a).then(l=>{g.robberPending=!1,g.robberResult=l,se(n,t)})})}),(r=n.querySelector("[data-robber-skip]"))==null||r.addEventListener("click",()=>{g.robberPending||g.robberResult||(g.robberResult=t.members[t.memberId].currentRole,se(n,t))}))}function We(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}let Y={roomId:"",memberId:"",round:-1};function is(n,e){var h,p,_;const t=e.state.roundNumber;(Y.roomId!==e.roomId||Y.memberId!==e.memberId||Y.round!==t)&&(Y={roomId:e.roomId,memberId:e.memberId,round:t});const s=e.members[e.memberId],i=Math.max(0,Math.ceil((e.state.discussEndsAt-Date.now())/1e3)),r=Math.floor(i/60),o=i%60,a=(s==null?void 0:s.knownRole)??(s==null?void 0:s.originalRole),l=Y.readyTapped||(s==null?void 0:s.discussReadyRound)===t,c=le(e),d=c.filter(w=>w.discussReadyRound===t).length,u=Y.hidden?'<p class="hint-text seer-memo">🙈 画面をかくしています</p>':`
      ${qs(e)}
      ${bn(e)}
