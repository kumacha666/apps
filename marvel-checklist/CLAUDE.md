...
- 新しい映画・シリーズを追加する際のチェックリスト:
  ...
  - Disney+ドラマシリーズを追加する際は、実写だけでなくMarvel Studios Animationのアニメ作品（『ホワット・イフ...?』『マーベル・ゾンビーズ』『スパイダーマン：フレッシュマン・イヤー』『アイズ・オブ・ワカンダ』等）も対象に含める。実写系シリーズだけで検索・追加すると見落としやすい（2026-08-08、Codexレビュー指摘でフレッシュマン・イヤーとアイズ・オブ・ワカンダの抜けを修正）
